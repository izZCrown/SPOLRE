...
from tools.PITI.pretrained_diffusion.script_util import (
...
def run(image, mode, sample_c=1.3,  num_samples=4, sample_step=100):
    ...
    if mode == 'mask':
        args.mode = 'coco'
        args_up.mode = 'coco'
        args.model_path = '/home/wgy/multimodal/tools/ckpt/base_mask.pt'
        args.sr_model_path = '/home/wgy/multimodal/tools/ckpt/upsample_mask.pt'
    ...
    with open('/home/wgy/multimodal/MuMo/PITI_model_options.json', 'w') as f:
        sample_data = {
            'base_model': options,
            'sample_model': options_up
        }
    ...
    while (True):
        ...
        with torch.no_grad():
            ...
            for hr in samples_hr:
                print('------')
                print(len(samples_hr))
                print(i)
                print('------')
                save_name = str(i) + '.png'
                i += 1
                save_path = '/home/wgy/multimodal/MuMo/output/' + save_name
...
if __name__ == "__main__":
    image_path = '/home/wgy/multimodal/tools/PITI/test_imgs/mask/000000070229.png'
    image = Image.open(image_path)
    mode = 'mask'
    save_path = '/home/wgy/multimodal/tools/PITI/outputs/000000070229.png'
    image = run(image=image, mode=mode)
